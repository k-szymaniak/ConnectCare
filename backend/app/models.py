...
class User(db.Model):
    ...
    skills = db.Column(db.String(300), nullable=True)  # Umiejętności (oddzielone przecinkami)
...
class Post(db.Model):
    ...
    skills = db.Column(db.String(300), nullable=True)  # Lista umiejętności w formie ciągu znaków (np. "skill1,skill2,skill3")
